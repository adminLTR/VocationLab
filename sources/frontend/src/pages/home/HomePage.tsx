...
export default function HomePage() {
    ...
    return <div className="home-page">
        <div className="py-20 max-w-10/12 mx-auto">
            ...
            <Title>
                <span className="text-[80px]">Transformamos la</span><br />
                <span className="text-transparent text-[80px] bg-clip-text bg-gradient-to-r from-main-500 to-secondary-600">
